...
{
    public class GameJumpingController : GSController  //maknuli GS
    {
        ...
        //
        // GET: /GameJumping/Create

        public ActionResult Create()
        {
            ViewBag.game = "Jump";
            ViewBag.CategoryID = new SelectList(db.tblCategories, "ID", "Name", 3);
            return View();
        }

        //
        // POST: /GameJumping/Create
        ...
        //
        // GET: /GameJumping/Edit/5

        public ActionResult Edit(int id = 0)
        {
            tblGame tblgame = db.tblGames.Find(id);
            //tblGame tblgame = db.vwGamesFull.Find(id);
            if (tblgame == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        public string SetRandomFields(int GameID = 30, string Field = "")
        {
        ...
        [HttpPost]
        public ActionResult AjaxSetStartField(string radiobutton, int GameID = 30)
        {
            radiobutton = HttpUtility.HtmlDecode(radiobutton);

            // EXEC setStartField @UserID, @radiobutton, @GameID
            var mf = db.setStartField(1, radiobutton, GameID);
